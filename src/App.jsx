...
function App() {
  ...
  const dadosFiltrados = midias.filter(item => item.tipo === categoriaSelecionada);
      ...
      <div style={{ padding: '30px', fontFamily: 'Arial, sans-serif', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', justifyContent: 'center' }}>
          <button
              ...
              style={{
                ...
                borderRadius: '4px',
                backgroundColor: categoriaSelecionada === 'toque' ? '#002f6c' : '#fff',
          ...
          <button
              ...
              style={{
                ...
                border: '1px solid #002f6c',
                borderRadius: '4px',
                backgroundColor: categoriaSelecionada === 'cancao' ? '#002f6c' : '#fff',
        ...
        {carregando ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
              <tr style={{ backgroundColor: '#002f6c', color: '#fff', textAlign: 'left' }}>
                <th style={{ padding: '12px', borderBottom: '2px solid #ddd' }}>
                  {categoriaSelecionada === 'toque' ? 'Nome do Toque' : 'Nome da Canção'}
                </th>
                <th style={{ padding: '12px', borderBottom: '2px solid #ddd', width: '300px' }}>Ouvir / Player</th>
              </tr>
              </thead>
              <tbody>
